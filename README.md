...
QPython Plus is forked from QPython (Standard) . QPython Plus is mainly aimed at Android 7.0 to 14 with 64bit, and it provides a lot of advanced technical features .
...
### Learn 学习
- Get more information from [wiki](https://github.com/qpython-android/qpython/wiki) for developing QPython (Standard) .
- Get more information from [开源库 in Bilibili](https://www.bilibili.com/read/readlist/rl321663) for developing QPython Plus .
...
- [Setup QPython Plus/3C](https://www.bilibili.com/read/cv13322251)
...
# Thanks to [QPython (Standard) project](https://github.com/qpython-android) very much !!!
