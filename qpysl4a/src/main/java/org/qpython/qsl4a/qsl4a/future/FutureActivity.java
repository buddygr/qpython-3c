...
/**
 * This {@link Activity} is launched by {@link }s in order to perform operations that a
...
public class FutureActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // River Modify
    FutureActivityTaskExecutor taskQueue = ((QSL4APP) getApplication()).getTaskExecutor();
