...
public class TedLocalActivity extends AppCompatActivity {
    ...
    public static void start(Context context, String folder_name) {
        Intent starter = new Intent(context, TedLocalActivity.class);
        starter.putExtra(EXTRA_REQUEST_CODE, REQUEST_CUSTOM_FOLDER);
        starter.putExtra(EXTRA_REQUEST_FN, folder_name);
        context.startActivity(starter);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (type) {
            ...
            case REQUEST_SAVE_AS:
                ...
                initSaveListener();
                fn = getIntent().getStringExtra(EXTRA_REQUEST_FN);
                if (fn!=null) {
            ...
            case REQUEST_CUSTOM_FOLDER:
                setTitle(R.string.explorer);
                fn = getIntent().getStringExtra(EXTRA_REQUEST_FN);
                firstPageFragment = ExplorerFragment.newInstance(REQUEST_CUSTOM_FOLDER, fn);
                break;
        }
