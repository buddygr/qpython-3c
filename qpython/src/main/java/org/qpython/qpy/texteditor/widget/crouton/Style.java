...
package org.qpython.qpy.texteditor.widget.crouton;
...
public class Style {
	...
	public static final int holoRedLight = 0xffeccd00;
	public static final int holoGreenLight = 0xff4bac07;
	public static final int holoBlueLight = 0xffeccd00;
	...
	public static class Builder {
		 ...
		 *            Resource ID of a backgroundDrawableResourceId image
		 *            drawable.
		 * @return the {@link Builder}.
		 */
		 ...
		 *            Resource ID of a dimension for the height of the
		 *            {@link Crouton} .
		 * @return the {@link Builder}.
		 */
		 ...
		 * 
		 * @param isTileEnabled
		 *            <code>true</code> if you want the backgroundResourceId to
		 *            be tiled, else <code>false</code>.
		 * @return the {@link Builder}.
		 */
